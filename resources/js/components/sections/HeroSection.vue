<template>
  <section ref="heroRef" class="relative h-screen flex items-center justify-center overflow-hidden ocean-wave-bg">
    <!-- Dark Ocean Background -->
    <div class="absolute inset-0 z-0">
      <div class="w-full h-full bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800">
        ...
        <div class="absolute inset-0 opacity-10">
          <div 
            ...
            :key="`wave-${i}`"
            ref="containerRefs"
            class="absolute w-8 h-4 bg-blue-300/20 rounded-sm wave-animation"
    ...
    <div class="absolute inset-0 z-10">
      <!-- Subtle premium waves -->
      <div class="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-blue-800/15 to-transparent wave-layer-1"></div>
      <div class="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-blue-700/10 to-transparent wave-layer-2"></div>
      <div class="absolute bottom-0 left-0 w-full h-12 bg-gradient-to-t from-blue-600/8 to-transparent wave-layer-3"></div>
      
      <!-- Premium floating elements -->
      <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-300/30 rounded-full premium-float"></div>
      <div class="absolute top-1/3 right-1/3 w-1 h-1 bg-blue-400/25 rounded-full premium-float" style="animation-delay: 2s;"></div>
      <div class="absolute top-2/3 left-1/3 w-1.5 h-1.5 bg-blue-300/20 rounded-full premium-float" style="animation-delay: 4s;"></div>
    </div>

    <!-- Professional Content -->
    <div ref="contentRef" class="relative z-20 text-center text-white px-6 max-w-5xl mx-auto">
      ...
      <div ref="ctaRef" class="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
        ...
        <router-link 
          ref="secondaryBtn"
          to="/services" 
          class="group bg-transparent border-2 border-blue-200 text-blue-200 hover:bg-blue-200 hover:text-ocean-deep px-10 py-5 rounded-xl font-semibold text-xl transition-all duration-500 transform hover:scale-105 backdrop-blur-sm"
        >
    ...
    <div ref="scrollIndicator" class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
      <div class="animate-bounce">
        <svg class="w-8 h-8 text-white premium-glow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
